    ...
    if params[:collect_by_name].present?
      ActionController::Base.helpers.link_to(
                                             title, all_trainings_trainings_path(
                                                                                ...
                                                                                ), class: 'btn btn-sm btn-primary text-decoration-none mx-1', id: "#{column}"
                                            )
    else
      ActionController::Base.helpers.link_to(title, all_trainings_trainings_path(sort_by: column, sort_direction: direction), class: 'btn btn-sm btn-primary text-decoration-none') 
    end
  end
